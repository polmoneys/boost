import $6nfFC$react, { useContext, useMemo, useState, useLayoutEffect, useRef, useCallback, useEffect, Fragment } from "react";
...
function Unit(props) {
  ...
  return /* @__PURE__ */ jsx$1($907718708eab68af$export$1a38b4ad7f578e1d, {
    autoFocus: autofocus,
    focusClass: nonKeyboard ? "ring" : "no-ring",
    focusRingClass: keyboard ? "ring-keyboard" : "no-ring-keyboard",
    within,
    children: /* @__PURE__ */ jsx$1(Fragment, {
      children
    })
  });
}
